...
* Version 2.3.1
    Thanks to Moonbow Dragon for screenshots and extra texturing tips.
    * Added: Screenshots for Animal and Accessory Guides.
    * Added: Texturing tips in [Tips for Beginners: Texturing](beginTexturing.md)
